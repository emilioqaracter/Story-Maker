...
| RF-134 | Cada 5 capítulos congelados, el Orquestador pasa al Jurado el conjunto dorado de defectos, con tantos casos como fija el perfil de la obra (`srs-backend-v4.md` D-131), y mide qué fracción detecta. Por debajo del 90 % (D-41) la señal «aciertos sobre el conjunto dorado» de §11 pasa a alarma y el Supervisor la recibe. El Jurado no sabe cuándo evalúa un caso dorado | `architecture.md` §11; `verification.md` §5.2 | VER-05, VER-10 |
