...
| PRO-15 | **Perfil de extensión** | Parámetro del brief (PRO-01) que fija los rangos de longitud de obra, capítulo y escena, y el umbral de aceptación del Jurado (CAL-09) y el mínimo de palabras de su cita. Dos valores: `novela`, por defecto, con los rangos de EST-07 y EST-08; y `prueba`, con obra de 1.200–1.800 palabras, exactamente 3 capítulos de 1 escena cada uno y escena de 400–600 palabras, que es también el rango del capítulo: unas 500 por capítulo, dentro de EST-08 y por debajo de EST-07. En `prueba` el Jurado aprueba con mediana 2 y no 3 y ancla citas de 5 palabras y no de 8. Existe para probar el ciclo entero en minutos y no en horas sin cambiar ningún verificador determinista: todos leen el rango del perfil, no una constante. |
