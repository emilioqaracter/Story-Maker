...
| PRO-15 | **Perfil de extensión** | Parámetro del brief (PRO-01) que fija los rangos de longitud de obra, capítulo y escena, y el umbral de aceptación del Jurado (CAL-09) y el mínimo de palabras de su cita. Tres valores: `novela`, por defecto, con los rangos de EST-07 y EST-08; `prueba`, con obra de 1.200–1.800 palabras, exactamente 3 capítulos de 1 escena cada uno y escena de 400–600 palabras, que es también el rango del capítulo: unas 500 por capítulo, dentro de EST-08 y por debajo de EST-07. En `prueba` el Jurado aprueba con mediana 2 y no 3 y ancla citas de 5 palabras y no de 8. Y `breve`, con obra de 10.000–15.000 palabras, exactamente 10 capítulos de 1 escena cada uno y escena de 1.000–1.500 palabras, que es también el rango del capítulo: dentro de EST-08 y por debajo de EST-07; el Jurado aprueba con mediana 2 y ancla citas de 8 palabras. `prueba` existe para probar el ciclo entero en minutos y no en horas, y `breve` para el encargo de diez capítulos breves; ninguno cambia un verificador determinista: todos leen el rango del perfil, no una constante. `breve` y `prueba` son además permisivos (D-136): los verificadores corren igual, pero solo un S1 determinista bloquea, y agotada la reparación se congela el mejor intento con sus defectos en la traza. |
