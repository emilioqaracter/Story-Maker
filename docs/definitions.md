...
| PRO-15 | **Perfil de extensión** | Parámetro del brief (PRO-01) que fija los rangos de longitud de obra, capítulo y escena, y el umbral de aceptación del Jurado (CAL-09) y el mínimo de palabras de su cita. Cuatro valores: `novela`, por defecto, con los rangos de EST-07 y EST-08; `prueba`, con obra de 1.200–1.800 palabras, exactamente 3 capítulos de 1 escena cada uno y escena de 400–600 palabras, que es también el rango del capítulo: unas 500 por capítulo, dentro de EST-08 y por debajo de EST-07. El Jurado aprueba con mediana 3 y ancla citas de 8 palabras en todos los perfiles. Y `breve`, con obra de 10.000–15.000 palabras, exactamente 10 capítulos de 1 escena cada uno y escena de 1.000–1.500 palabras, que es también el rango del capítulo: dentro de EST-08 y por debajo de EST-07. Y `corta`, que es `breve` con exactamente 5 capítulos y obra de 5.000–7.500 palabras. `prueba` existe para probar el ciclo entero en minutos y no en horas, `breve` para el encargo de diez capítulos breves y `corta` para probar el ciclo con cinco; ninguno cambia un verificador determinista: todos leen el rango del perfil, no una constante. Ningún perfil es permisivo: las puertas son las mismas en los cuatro (`specs/srs-backend-v4.md` D-142). |
