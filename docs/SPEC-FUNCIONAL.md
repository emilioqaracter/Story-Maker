...
| **redactor** | Escribe el capítulo y lo relee antes de entregarlo, para que no salga de sus manos con erratas, tildes que faltan ni nombres que cambian de grafía. Cuando le llega una luz roja, lo reescribe atendiendo solo a lo que le señalaron. | nada |
...
| **1.7** | 2026-09-18 | El redactor revisa su propio borrador antes de entregarlo: ortografía, palabras cortadas, concordancia, grafía de los nombres, puntuación del diálogo y el tiempo verbal del plan (§2). La lección de la luz se define por su destino —convertirse en regla permanente del redactor— y deja de gastarse en erratas (§5). | Dos novelas de control seguidas enseñaron que los jueces gastaban luces rojas y lecciones en cosas mecánicas: una tilde o un «la txuleta» que pasa a «el txuleta» consumía uno de los tres intentos del redactor y ocupaba el sitio de la lección que enseña a escribir. Ver eso no pide criterio, así que no pide un juez. |
| **1.8** | 2026-09-18 | Toda luz verde termina con un refuerzo: la capacidad que el capítulo sostuvo bien. La lección de una roja nombra la capacidad general y no la situación en que falló (§5). | Una luz verde muda no le enseña nada a quien escribe, y una lección atada a la situación del capítulo solo sirve si la situación se repite. Las dos cosas se vieron en las novelas de control: tres verdes sin una línea, y lecciones que hablaban de recuerdos en vez de hablar de tiempos verbales. |
