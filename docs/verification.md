...
| Que en el perfil de extensión `prueba` el conjunto dorado de CAL-10 detecte peor | Con un párrafo por escena no sale el caso de párrafo duplicado, y con menos casos la tasa tiene más varianza; corre una vez, al congelar el último capítulo (`specs/srs-backend-v4.md` D-112) | La tasa del conjunto dorado en la traza de VER-09, que en el perfil `novela` se mide cada 5 capítulos |
